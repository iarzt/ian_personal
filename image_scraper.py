...
def get_image_links(url):
    ...
    image_links = re.findall('http://texassports.com/images/2019/9/20/[a-zA-Z]+_[a-zA-Z]+_2019.jpg', bigger_soup)
    
    return image_links

def get_name(image_link):
    name = image_link.lstrip('https://texassports.com/images/2019/9/20/').rstrip('_2019.jpg')
    name = name.split('_')
    name.reverse()
    return '_'.join(name)
